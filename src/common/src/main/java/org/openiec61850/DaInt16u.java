...
public final class DaInt16u extends BasicDataAttribute {

	private Integer value;

	public DaInt16u(ObjectReference objectReference, FunctionalConstraint fc, String sAddr, Integer value,
			boolean dchg, boolean dupd) {
		this.objectReference = objectReference;
		this.fc = fc;
		this.sAddr = sAddr;
		this.basicType = DaType.INT16U;
		this.value = value;
		this.dchg = dchg;
		this.dupd = dupd;
	}
	...
	@Override
	public DaInt16u copy() {
		return new DaInt16u(objectReference, fc, sAddr, value, dchg, dupd);
	}
