...
public final class DaInt8u extends BasicDataAttribute {

	private Short value;

	public DaInt8u(ObjectReference objectReference, FunctionalConstraint fc, String sAddr, Short value, boolean dchg,
			boolean dupd) {
		this.objectReference = objectReference;
		this.fc = fc;
		this.sAddr = sAddr;
		this.basicType = DaType.INT8U;
		this.value = value;
		this.dchg = dchg;
		this.dupd = dupd;
	}
	...
	@Override
	public DaInt8u copy() {
		return new DaInt8u(objectReference, fc, sAddr, value, dchg, dupd);
	}
