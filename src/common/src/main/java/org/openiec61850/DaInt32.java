...
public final class DaInt32 extends BasicDataAttribute {

	private Integer value;

	public DaInt32(ObjectReference objectReference, FunctionalConstraint fc, String sAddr, Integer value, boolean dchg,
			boolean dupd) {
		this.objectReference = objectReference;
		this.fc = fc;
		this.sAddr = sAddr;
		this.basicType = DaType.INT32;
		this.value = value;
		this.dchg = dchg;
		this.dupd = dupd;
	}
	...
	@Override
	public DaInt32 copy() {
		return new DaInt32(objectReference, fc, sAddr, value, dchg, dupd);
	}
